...
router.post('/cell', authenticate, requireRule('timesheet', 'READ'), timesheetController.upsertCell);
// Support both POST and PUT for upsert (POST for backwards compat, PUT is semantically correct)
router.post('/cell/upsert', authenticate, requireRule('timesheet', 'READ'), timesheetController.upsertCell);
router.put('/cell', authenticate, requireRule('timesheet', 'READ'), timesheetController.upsertCell);
