...
const options: swaggerJsdoc.Options = {
  definition: {
    ...
    tags: [
      ...
      { name: 'International Products', description: 'Hàng hóa quốc tế (Kinh doanh)' },
      ...
      { name: 'Finished Products', description: 'Hàng hóa hoàn thành (Sản xuất)' },
      ...
      { name: 'Lot Products', description: 'Hàng hóa trong lô (Sản xuất)' },
