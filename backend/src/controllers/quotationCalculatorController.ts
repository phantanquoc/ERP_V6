...
export class QuotationCalculatorController {
  async getCalculatorByQuotationRequestId(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  async upsertCalculator(req: Request, res: Response, next: NextFunction) {
    try {
      const data = req.body;
  ...
  async deleteCalculator(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  async createQuotationFromCalculator(req: Request, res: Response, next: NextFunction) {
    try {
...
export default new QuotationCalculatorController();
