# pricing-room-review-tabs Specification

## Purpose

Pricing Room purchase-request review tab: server-derived approval audit, detail modal labels and scroll, and action-column iconography.
