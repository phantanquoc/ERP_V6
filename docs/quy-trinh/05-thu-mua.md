...
| --------------------------------------------------- | ---------------------------------------- | --------------- | ---------------------------------------------------- |
| Nhân viên không thể tạo yêu cầu mua hàng            | Nhân viên → Tổ trưởng                    | Ngay lập tức    | Kiểm tra quyền truy cập, hỗ trợ tạo yêu cầu          |
| Yêu cầu mua hàng chưa được duyệt quá 2 ngày         | Tổ trưởng → Trưởng phòng                 | 1 ngày làm việc | Nhắc nhở duyệt, kiểm tra ưu tiên                     |
| Nhà cung cấp không đủ điều kiện hoặc không phản hồi | Tổ trưởng → Trưởng phòng                 | 1 ngày làm việc | Tìm NCC thay thế, cập nhật trạng thái                |
| Đơn hàng vượt hạn mức chi tiêu                      | Trưởng phòng → Quản trị viên             | 2 ngày làm việc | Xin phê duyệt bổ sung, cập nhật hạn mức              |
| Lỗi sinh mã NCC hoặc lỗi phân quyền                 | Trưởng phòng → Quản trị viên             | Ngay lập tức    | Kiểm tra cấu hình hệ thống, reset dữ liệu nếu cần    |
| Không xuất được Excel                               | Tổ trưởng → Trưởng phòng → Quản trị viên | 1 ngày làm việc | Kiểm tra quyền, dung lượng server, định dạng dữ liệu |
| Yêu cầu mua hàng bị từ chối                         | Nhân viên → Người duyệt                  | Ngay lập tức    | Xem lý do trong ghi chú mua hàng, tạo lại nếu cần    |
| Upload file thất bại                                | Nhân viên → Tổ trưởng                    | Ngay lập tức    | Kiểm tra định dạng file, kích thước, kết nối mạng    |
| Thông báo không được gửi                            | Tổ trưởng → Trưởng phòng → Quản trị viên | 1 ngày làm việc | Kiểm tra cấu hình thông báo, log hệ thống            |
| Sự cố kỹ thuật (load dữ liệu chậm, crash)           | Báo ngay cho Quản trị viên               | Ngay lập tức    | Kèm ảnh chụp màn hình lỗi, thời gian xảy ra          |
...
> Luồng xử lý: `Chờ duyệt` → `Đã duyệt` hoặc `Từ chối` → `Hoàn thành`. Người có quyền Tổ trưởng trở lên mới được thay đổi trạng thái.
>
...
> Có. Vào tab **Nhà cung cấp** của phòng tương ứng, nhấn nút **Xuất Excel**. Yêu cầu quyền Tổ trưởng trở lên. File Excel sẽ chứa tất cả thông tin nhà cung cấp (mã, tên, loại cung cấp, quốc gia, liên hệ, loại hình, trạng thái, doanh chi, nhân viên tạo).
...
> Có, nhưng chỉ người có quyền Trưởng phòng trở lên mới được xóa. Vào tab **Nhà cung cấp** → nhấn nút **Xóa** (thùng rác) trên dòng nhà cung cấp → xác nhận "Bạn có chắc chắn muốn xóa nhà cung cấp này?". Lưu ý: nếu nhà cung cấp đã được sử dụng trong yêu cầu mua hàng, hệ thống có thể không cho phép xóa.
