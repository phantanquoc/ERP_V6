...
| ------------------- | -------------------------- | ---------- | ------------------------ |
| Chưa báo cáo        | Chưa báo cáo               | Xám        | Chưa nộp báo cáo kỳ này  |
| Đang cập nhật hồ sơ | Đang cập nhật hồ sơ        | Vàng       | Đang thu thập chứng từ   |
| Đã đầy đủ hồ sơ     | Đã đầy đủ hồ sơ để báo cáo | Xanh dương | Đủ điều kiện nộp         |
| Đã báo cáo          | Đã báo cáo                 | Xanh lá    | Đã nộp lên cơ quan thuế  |
| Đã quyết toán       | Đã quyết toán              | Tím        | Hoàn tất quyết toán thuế |
...
| ----------------------------------------------- | ---------------------------- | ---------------- |
| Hóa đơn chưa thanh toán quá 30 ngày             | Tổ trưởng → Trưởng phòng     | 2 ngày làm việc  |
| Công nợ đến hạn chưa thanh toán                 | Trưởng phòng                 | Ngay khi đến hạn |
| Chênh lệch số liệu doanh thu > 5%               | Trưởng phòng → Quản trị viên | 1 ngày làm việc  |
| Báo cáo thuế trạng thái Chưa báo cáo gần kỳ hạn | Trưởng phòng                 | 3 ngày trước hạn |
| Đơn hàng xuất khẩu chưa có thanh toán đợt 2     | Tổ trưởng → Trưởng phòng     | Theo hợp đồng    |
| Lô hàng chưa cập nhật đơn giá                   | Tổ trưởng                    | 1 ngày làm việc  |
| Tài sản ghi nhận âm / sai lệch lớn              | Trưởng phòng → Quản trị viên | Ngay lập tức     |
...
Có. Vào tab **Danh sách đơn hàng** → tìm đơn hàng → nhấn Sửa → chọn trạng thái mới trong dropdown **Trạng thái SX**. Lưu ý: chỉ role Tổ trưởng trở lên mới có quyền sửa.
...
Trạng thái nên được chuyển theo thứ tự: Chưa báo cáo → Đang cập nhật hồ sơ → Đã đầy đủ hồ sơ → Đã báo cáo → Đã quyết toán. Chỉ Trưởng phòng hoặc Quản trị viên mới có quyền tạo và cập nhật báo cáo thuế.
