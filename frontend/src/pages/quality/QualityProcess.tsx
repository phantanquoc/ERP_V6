        ...
        {isProcessModalOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4 overflow-y-auto">
            <div className="bg-white rounded-lg shadow-xl w-[calc(100vw-1rem)] sm:max-w-4xl sm:w-full my-2 sm:my-8 flex flex-col max-h-[calc(100vh-1rem)] sm:max-h-[calc(100vh-2rem)]">
              ...
              <form onSubmit={handleProcessSubmit} className="p-4 sm:p-6 space-y-4 overflow-y-auto flex-1">
                {/* Basic Info */}
                      ...
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4">
                        ...
                        {processFormData.sections.length > 1 && (
                          <button
                            ...
                            className="sm:ml-2 px-3 py-2 bg-red-600 text-white rounded hover:bg-red-700 self-start"
                          >
                            Xóa
                          </button>
                        )}
