                      ...
                      <table className="w-full text-sm">
                        ...
                        <tbody className="divide-y divide-gray-100">
                          ...
                          <tr className="hover:bg-gray-50/50">
                            ...
                            <td className="py-1.5 px-2"><input type="number" step="0.01" value={currentAdditionalTab.formData.tongThanhPhamCanSxThemThucTe || ''} disabled className="w-full px-2 py-1.5 text-sm border border-dashed border-gray-300 rounded-md text-center bg-slate-50 text-emerald-700 font-medium" /></td>
                          </tr>
                          <tr className="hover:bg-gray-50/50">
                            ...
                            <td className="py-1.5 px-2"><input type="number" step="0.01" value={currentAdditionalTab.formData.tongNguyenLieuCanSanXuatThucTe || ''} onChange={(e) => updateAdditionalTabFormData(currentAdditionalTab.id, 'tongNguyenLieuCanSanXuatThucTe', parseNumberInputStr(e.target.value))} className="w-full px-2 py-1.5 text-sm border border-emerald-200 rounded-md text-center focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 bg-white" placeholder="Nhập" /></td>
                          </tr>
                          <tr className="hover:bg-gray-50/50">
