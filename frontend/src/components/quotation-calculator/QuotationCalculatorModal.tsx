...
const QuotationCalculatorModal: React.FC<QuotationCalculatorModalProps> = ({
  ...
  return (
    ...
    <Modal isOpen={isOpen} onClose={onClose} showBackdrop>
      <div className="bg-white rounded-lg shadow-xl max-w-[95vw] w-full flex flex-col modal-viewport-h" onClick={(e) => e.stopPropagation()}>
        {/* Header */}
                      ...
                      <table className="w-full text-sm">
                        ...
                        <tbody className="divide-y divide-gray-100">
                          <tr className="hover:bg-gray-50/50">
                            ...
                            <td className="py-1.5 px-2"><input type="number" step="0.01" value={currentAdditionalTab.formData.tongKhoiLuongThanhPhamThucTe && currentAdditionalTab.formData.tongNguyenLieuCanSanXuat ? ((parseFloat(String(currentAdditionalTab.formData.tongKhoiLuongThanhPhamThucTe)) / parseFloat(String(currentAdditionalTab.formData.tongNguyenLieuCanSanXuat))) * 100).toFixed(2) : ''} disabled className="w-full px-2 py-1.5 text-sm border border-dashed border-gray-300 rounded-md text-center bg-slate-50 text-emerald-700 font-medium" placeholder="Tự động" /></td>
                          </tr>
                          <tr className="hover:bg-gray-50/50">
                            ...
                            <td className="py-1.5 px-2"><input type="number" step="0.01" value={currentAdditionalTab.formData.tongNguyenLieuCanSanXuat && currentAdditionalTab.formData.tiLeThuHoi ? (parseFloat(String(currentAdditionalTab.formData.tongNguyenLieuCanSanXuat)) * parseFloat(String(currentAdditionalTab.formData.tiLeThuHoi)) / 100).toFixed(2) : '0'} readOnly className="w-full px-2 py-1.5 text-sm border border-dashed border-gray-300 rounded-md text-center bg-slate-50 text-blue-700 font-medium" /></td>
