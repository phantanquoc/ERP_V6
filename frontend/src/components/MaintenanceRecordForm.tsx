...
const MaintenanceRecordForm = ({ mode, record, systems, onClose, lockedMachineSystemId, onEdit }: Props) => {
    ...
    <ModalForm
      ...
      footer={isView ? (
        <div className="flex justify-end gap-3">
          <button onClick={onClose} className="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50">Đóng</button>
          {onEdit && (
            <button onClick={onEdit} className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">Chỉnh sửa</button>
          )}
        </div>
      ) : (
        <ModalFooter
