...
const API_URL = 'http://localhost:5000/api/quotation-requests';
...
export const quotationRequestService = {
  async getAllQuotationRequests(page: number = 1, limit: number = 10, search?: string): Promise<PaginatedResponse> {
