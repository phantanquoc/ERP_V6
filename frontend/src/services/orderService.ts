...
class OrderService {
  ...
  // Get all orders
  async getAllOrders(page: number = 1, limit: number = 20, search?: string, customerType?: string, status?: string, dateFrom?: string, dateTo?: string, month?: number, year?: number) {
