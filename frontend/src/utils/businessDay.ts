/**
 * Business Day Utilities (Frontend)
...
/**
 * Get business day label for display
 * 
 * @example
 * getBusinessDayLabel('2026-01-09')
 * // Returns: "Ngày 09/01/2026 (3h sáng - 3h sáng hôm sau)"
 */
export const getBusinessDayLabel = (date: Date | string): string => {
  ...
  return `Ngày ${day}/${month}/${year} (${BUSINESS_DAY_START_HOUR}h sáng - ${BUSINESS_DAY_START_HOUR}h sáng hôm sau)`;
};
